...
/**
 * This is sourced from: https://github.com/gelitenight/WaveView
 *
 *
 */
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = ResourceUtil.GetColor(R.color.wave_behind_color);
    public static final int DEFAULT_FRONT_WAVE_COLOR = ResourceUtil.GetColor(R.color.wave_front_color);
